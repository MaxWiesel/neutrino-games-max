...
void	FBCopyImageCol( int x, int y, int dx, int dy, unsigned char col, unsigned char *src )
{
	if (doexit == 3)
		return;
...
int	FBInitialize( int xRes, int yRes, int bpp, int extfd )
{
	...
	window = XCreateSimpleWindow(dpy,RootWindow(dpy,0), 100, 100, xRes, yRes, 0, 0, 0 );
